...
//   const authHeader = req.headers[authorization]; 
  ...
  try {
    const decoded = jwt.verify(token, process.env.JWT_USER_PASSWORD); //yai decoded token ko verify kar raha h, agar token valid h to decoded me user ka data aayega, yaha secret key use kar raha h jo env file me stored h
    req.userId = decoded.id; // yai user id ko request object me attach kar raha h taki aage ke controllers me use kar sake
