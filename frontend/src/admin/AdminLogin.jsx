 ...
 const handleSubmit = async (e) => {
  ...
  try {
    const response = await axios.post(
      "https://courseapp-br7n.onrender.com/api/admin/login",
      { email, password },
      {
      ...
      <nav className="bg-slate-900 shadow-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="hidden md:flex space-x-6 items-center">
              <Link to="/admin/signup" className="text-indigo-500 font-semibold">
                signup
              </Link>
        ...
        {isOpen && (
          <div className="md:hidden bg-slate-800 px-4 py-4 space-y-3">
            <Link to="/admin/signup" className="block text-indigo-400">
              signup
            </Link>
      ...
      <div className="flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-md bg-slate-800 rounded-2xl shadow-2xl shadow-indigo-600/20 p-8">
          ...
          <p className="text-center font-bold text-gray-500 mb-3">
            Login to acess admin dashboard
          </p>
